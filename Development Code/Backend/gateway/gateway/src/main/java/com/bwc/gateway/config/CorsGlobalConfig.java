...
public class CorsGlobalConfig {
    ...
    public CorsWebFilter corsWebFilter() {
        ...
        config.setAllowedOrigins(List.of(
            ...
            "http://bwc-97.brainwaveconsulting.co.in:3000",
            "http://bwc-97.brainwaveconsulting.co.in:3001",
            "http://bwc-97.brainwaveconsulting.co.in:3002",
            "http://bwc-97.brainwaveconsulting.co.in:3003",
        ...
        config.setAllowedMethods(List.of("GET", "POST", "PUT", "DELETE", "PATCH", "OPTIONS")); // ✅ Add PATCH
